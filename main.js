...
const aiimgCommand = require('./commands/aiimg');
const aiassistCommand = require('./commands/flux');
const aicodeCommand = require('./commands/aicode');
const aitranslateCommand = require('./commands/aitranslate');
const imageCommand = require('./commands/image');
const animeImageCommand = require('./commands/animeimage');
...
async function handleMessages(sock, messageUpdate, printLog) {
    ...
    await imageCommand(sock, chatId, message, args);
    break;
case userMessage.startsWith('.animeimage'):
    await animeImageCommand(sock, chatId, message, args);
    break;
case userMessage === '.donate' || userMessage === '.donation':
    await donationCommand(sock, chatId, message);
    break;
            ...
            case userMessage === '.tagnotadmin':
                ...
                break;
                // Case 1: AI Chat Command
case userMessage.startsWith('.aichat'):
    await aichatCommand(sock, message, chatId, senderId, userMessage);
    commandExecuted = true;
    break;

// Case 2: AI Image Generation Command
case userMessage.startsWith('.aiimg'):
    await aiimgCommand(sock, message, chatId, senderId, userMessage);
    commandExecuted = true;
    break;

// Case 3: AI Assistant Command
case userMessage.startsWith('.flux'):
    await fluxCommand(sock, message, chatId, senderId, userMessage);
    commandExecuted = true;
    break;

// Case 4: AI Code Helper Command
case userMessage.startsWith('.aicode'):
    await aicodeCommand(sock, message, chatId, senderId, userMessage);
    commandExecuted = true;
    break;

// Case 5: AI Translation Command
case userMessage.startsWith('.aitranslate'):
    await aitranslateCommand(sock, message, chatId, senderId, userMessage);
    commandExecuted = true;
    break;
